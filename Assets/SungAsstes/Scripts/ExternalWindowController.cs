...
public class ExternalWindowController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            renderTextureCamera.backgroundColor = _mainCam.backgroundColor;
            renderTextureCamera.clearFlags = _mainCam.clearFlags;
        }
