    ...
    public static class LaserArrayLibrary
    {
        public static readonly Dictionary<LidarModel, LaserArray> ByModel =
            new Dictionary<LidarModel, LaserArray>
            {
                ...
                {LidarModel.MyLidar, MyLidar},
            };

        public static LaserArray MyLidar => new LaserArray
        {
            centerOfMeasurementLinearOffsetMm = new Vector3(0.0f, 37.7f, 0.0f),
            focalDistanceMm = 0.0f,
            lasers = new[]
            {
                new Laser {horizontalAngularOffsetDeg = 15.0f, verticalAngularOffsetDeg = +1.4f, ringId = 1, timeOffset = 0.0f},
                new Laser {horizontalAngularOffsetDeg = 10.0f, verticalAngularOffsetDeg = -1.4f, ringId = 2, timeOffset = 0.001f},
                new Laser {horizontalAngularOffsetDeg = 0.0f, verticalAngularOffsetDeg = +1.4f, ringId = 3, timeOffset = 0.002f},
                new Laser {horizontalAngularOffsetDeg = -10.0f, verticalAngularOffsetDeg = -1.4f, ringId = 4, timeOffset = 0.003f},
                new Laser {horizontalAngularOffsetDeg = -15.0f, verticalAngularOffsetDeg = -1.4f, ringId = 5, timeOffset = 0.004f},
            }
        };
